...
void Pipe::SpawnPipe( cocos2d::Layer *layer)
{
    ...
    auto topPipe = Sprite::create("/home/chus/Juego/Juego/Resources/iphone/Pipe.png");
    ...
    bottomPipe->setPosition(Point( topPipe->getPositionX(), topPipePosition - (Sprite::create("/home/chus/Juego/Juego/Resources/iphone/Ball.png")->getContentSize().height * PIPE_GAP ) - topPipe->getContentSize().height ) );
